...
from gmr_harness._math_utils import IDENTITY_QUAT
from gmr_harness.alignment.body_matcher import MatchResult
...
def generate_ik_config(
    ...
    *,
    ...
    """
    from gmr_harness.alignment.orientation_aligner import compute_world_rotation
    ...
    scale_table.setdefault(skeleton.root_name, skeleton.scale_defaults.get(skeleton.root_name, 0.9))
...
def _default_ik_config_dir() -> Path:
    ...
    return find_gmr_root() / "general_motion_retargeting" / "ik_configs"
