...
from gmr_harness.alignment.skeleton_maps import HumanSkeleton
...
_RULES: dict[str, list[_Rule]] = {
    "left_hip": [
        _Rule(r"^LINK_HIP_ROLL_L$"),
        _Rule(r"^LINK_HIP_YAW_L$"),
        _Rule(r"^LINK_HIP_PITCH_L$"),
    ...
    "right_hip": [
        _Rule(r"^LINK_HIP_ROLL_R$"),
        _Rule(r"^LINK_HIP_YAW_R$"),
        _Rule(r"^LINK_HIP_PITCH_R$"),
    ...
    "left_foot": [
        _Rule(r"^LINK_ANKLE_ROLL_L$"),
        _Rule(r"^LINK_FOOT_L$"),
        _Rule(r"^LINK_ANKLE_PITCH_L$"),
    ...
    "right_foot": [
        _Rule(r"^LINK_ANKLE_ROLL_R$"),
        _Rule(r"^LINK_FOOT_R$"),
        _Rule(r"^LINK_ANKLE_PITCH_R$"),
    ...
    "left_shoulder": [
        _Rule(r"^LINK_SHOULDER_ROLL_L$"),
        _Rule(r"^LINK_SHOULDER_YAW_L$"),
        _Rule(r"^LINK_SHOULDER_PITCH_L$"),
    ...
    "right_shoulder": [
        _Rule(r"^LINK_SHOULDER_ROLL_R$"),
        _Rule(r"^LINK_SHOULDER_YAW_R$"),
        _Rule(r"^LINK_SHOULDER_PITCH_R$"),
    ...
    "left_elbow": [
        _Rule(r"^LINK_ELBOW_PITCH_L$"),
        _Rule(r"^LINK_ELBOW_YAW_L$"),
    ...
    "right_elbow": [
        _Rule(r"^LINK_ELBOW_PITCH_R$"),
        _Rule(r"^LINK_ELBOW_YAW_R$"),
