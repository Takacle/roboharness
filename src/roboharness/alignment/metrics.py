...
from roboharness._math_utils import rotation_matrix_to_axis_angle
...
def compute_direct_patch(
    ...
    Returns
    -------
    A patch dict with ``mode: "set"`` for every computed quaternion.
    """
    ...
    for table_name in ("ik_match_table1", "ik_match_table2"):
        ...
        for robot_joint_name, entry in table.items():
            ...
            _, q_human = human_data[human_bone_name]
